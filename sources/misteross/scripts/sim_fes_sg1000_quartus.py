#!/usr/bin/env python3
"""Check SG-1000 RAM/media against unmodified, locally supplied Intel models."""
...
from scripts.build_fes_sg1000 import SYSTEMVERILOG_SOURCES, VERILOG_SOURCES
...
def main() -> None:
    ...
    output = root / "build/sim/fes-sg1000-quartus"
    ...
    for test in ("quartus_ram_tb", "quartus_media_tb"):
        ...
        command += [
            ...
            "-o",
            str(binary),
            str(root / f"cores/fes-sg1000/sim/{test}.sv"),
            *map(str, selected),
            str(model),
        ]
