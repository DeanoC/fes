// Independent-clock 512x20 M10K with two 10-bit write lanes.
module top #(
    parameter [15:0] SIGNATURE = 16'hD41A
) (
    ...
    // GPO[5:4] is the lane mask; those bits are forced out of the write address.
    reg armed = 1'b0;
