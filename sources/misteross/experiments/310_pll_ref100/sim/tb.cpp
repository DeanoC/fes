...
int main(int argc, char **argv) {
    ...
    const unsigned lo[3] = {1023U, 2047U, 4095U};
    const unsigned hi[3] = {1025U, 2049U, 4097U};
    ...
    std::cout << "PASS: 100 MHz-ref meters; reset zero, released 1024/2048/4096\n";
}
