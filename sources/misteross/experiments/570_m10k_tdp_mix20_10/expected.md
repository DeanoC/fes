...
512-by-20 port A and 1024-by-10 port B. Port A uses
the 50 MHz board clock. Port B uses an independently gated 25 MHz PLL output.
GPI signature `0xD421`; `[15:0]` are a 16-bit window of the selected
port.
...
`make sim EXP=570_m10k_tdp_mix20_10` and `make oss EXP=570_m10k_tdp_mix20_10`.
