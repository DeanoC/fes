...
int main(int argc, char **argv) {
    ...
    const unsigned lo[3] = {4095U, 4095U, 4095U};
    const unsigned hi[3] = {4097U, 4097U, 4097U};
    ...
    std::cout << "PASS: 25 MHz-ref meters; reset zero, released 4096 and 25 MHz digital 50/100 MHz stand-ins\n";
}
