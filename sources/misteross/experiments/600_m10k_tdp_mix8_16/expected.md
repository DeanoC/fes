...
1024-by-8 port A and 512-by-16 port B. Port A uses
the 50 MHz board clock. Port B uses an independently gated 25 MHz PLL output.
GPI signature `0xD424`; `[15:0]` are a 16-bit window of the selected
port.
...
`make sim EXP=600_m10k_tdp_mix8_16` and `make oss EXP=600_m10k_tdp_mix8_16`.
