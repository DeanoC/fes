...
After configuration the high 16 GPI bits stay `0xD610`. The low 8 bits are the
...
The sixteen-bit product is `left * right`, implemented in a DSP block. One
...
transcript. Exactly one DSP block is used. M10K and MLAB stay unused.
