// Simulation only: 50 MHz outputs. 180/270 are inverted; 90 is a 50 MHz
// stand-in. Analog 5 ns 90/270 phase is not modeled.
module altera_pll #(
    ...
    parameter phase_shift2 = "10000 ps",
    parameter phase_shift3 = "15000 ps",
