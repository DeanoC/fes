...
constexpr uint32_t kSignature = 0xd4180000U;
...
int main(int argc, char **argv) {
    ...
    std::cout << "PASS: independent-clock 20-bit M10K SDP init, stopped-clock write, enables\n";
    return EXIT_SUCCESS;
}
