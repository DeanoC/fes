// True-dual-port 512x20 M10K. Locked Yosys has no ADDRSTALL ports, so
// GPO[29] is attached to ADDRSTALLA after synthesis.
module top #(
    parameter [15:0] SIGNATURE = 16'hD42C
) (
