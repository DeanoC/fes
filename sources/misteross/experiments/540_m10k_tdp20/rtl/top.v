// Independent-clock true dual-port 512-by-20 table on HPS GP.
// GPO addr[8:0], clock-B gate[14], seed[25:16], select B[26],
// window[27], enable A/B[28/29], write A/B[30/31].
module top #(
    parameter [15:0] SIGNATURE = 16'hD41E
) (
    ...
    (* ram_style = "m10k_tdp" *) reg [19:0] mem [0:511];
    reg [19:0] q_a = 20'd0;
    reg [19:0] q_b = 20'd0;
    integer i;
