...
int main(int argc, char **argv) {
    ...
    for (unsigned channel = 0; channel < 2; ++channel) {
        select(channel);
        unsigned lo = channel ? 1006U : 2047U;
        unsigned hi = channel ? 1007U : 2049U;
    ...
    std::cout << "PASS: two-PLL meters; reset zero, released 2048 and 1006-1007\n";
}
