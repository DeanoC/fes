...
RTL = ROOT / "experiments" / "060_dsp_mul" / "rtl" / "top.v"
TB = ROOT / "experiments" / "060_dsp_mul" / "sim" / "tb.cpp"
EXPECTED = ROOT / "experiments" / "060_dsp_mul" / "expected.md"
ORACLE_QSF = ROOT / "experiments" / "060_dsp_mul" / "oracle" / "top.qsf"
ORACLE_QPF = ROOT / "experiments" / "060_dsp_mul" / "oracle" / "top.qpf"
MODEL = ROOT / "experiments" / "020_linux_mailbox" / "sim" / "hps_gp_model.v"


class DspMulSourcePolicyTests(unittest.TestCase):
    ...
    def test_production_source_satisfies_closed_policy(self) -> None:
        ...
        relative = "experiments/060_dsp_mul/rtl/top.v"
    ...
    def test_oracle_project_omits_simulation_model_and_led(self) -> None:
        ...
        self.assertIn("experiments/060_dsp_mul/rtl/top.v", qsf)
