...
class PllPhase100Tests(unittest.TestCase):
    def test_closed_resources_and_sources(self):
        policy = policy_for("330_pll_phase100")
        ...
        rtl = (ROOT / "experiments/330_pll_phase100/rtl/top.v").read_text()
        policy.validate_source_text("experiments/330_pll_phase100/rtl/top.v", rtl)
        self.assertIn('.number_of_clocks(4)', rtl)
        self.assertIn('.output_clock_frequency0("100.0 MHz")', rtl)
        self.assertIn('.output_clock_frequency3("100.0 MHz")', rtl)
        self.assertIn('.phase_shift0("0 ps")', rtl)
        self.assertIn('.phase_shift1("2500 ps")', rtl)
        self.assertIn('.phase_shift2("5000 ps")', rtl)
        self.assertIn('.phase_shift3("7500 ps")', rtl)
        self.assertIn("16'hD724", rtl)
