...
class PllDsp40Tests(unittest.TestCase):
    def test_closed_resources_and_sources(self):
        ...
        self.assertEqual(dict(policy.additional_clocks_mhz), {"clk40": 40.0})
        self.assertEqual(
    ...
    def test_both_clock_domains_required(self):
        ...
        generated = {"constraint": 40, "achieved": 300}
        cases = [
            ({"host_port.FPGA_CLK1_50": ref, "clk40": generated}, True),
            ({"host_port.FPGA_CLK1_50": ref}, False),
            ({"clk40": generated}, False),
            ({"host_port.FPGA_CLK1_50": ref, "clk40": {"constraint": 25, "achieved": 300}}, False),
            ({"host_port.FPGA_CLK1_50": ref, "clk40": {"constraint": 40, "achieved": 39}}, False),
        ]
