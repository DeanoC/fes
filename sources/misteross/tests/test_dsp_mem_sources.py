...
ORACLE_QSF = ROOT / "experiments" / "080_dsp_mem" / "oracle" / "top.qsf"
ORACLE_QPF = ROOT / "experiments" / "080_dsp_mem" / "oracle" / "top.qpf"
...
class DspMemSourcePolicyTests(unittest.TestCase):
    ...
    def test_oracle_project_omits_simulation_model_and_led(self) -> None:
        ...
        self.assertIn("experiments/080_dsp_mem/rtl/top.v", qsf)
