...
// Capture a 256x192 six-bit SMS raster and present it as centered 2x graphics.

module sms_video_720p (
    input  wire       clk_sys,
    input  wire       pixel_clk,
    input  wire       raster_ce,
    input  wire [7:0] logical_x,
    input  wire [7:0] logical_y,
    input  wire [5:0] logical_color,
    ...
    wire [5:0] framebuffer_q_a;
    wire [5:0] framebuffer_q;
    ...
    always @* begin
        ...
        if (image_active) begin
            red = {framebuffer_q[1:0], framebuffer_q[1:0],
                   framebuffer_q[1:0], framebuffer_q[1:0]};
            green = {framebuffer_q[3:2], framebuffer_q[3:2],
                     framebuffer_q[3:2], framebuffer_q[3:2]};
            blue = {framebuffer_q[5:4], framebuffer_q[5:4],
                    framebuffer_q[5:4], framebuffer_q[5:4]};
        end
    end
