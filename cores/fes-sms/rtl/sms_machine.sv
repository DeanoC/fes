...
// Reduced Master System machine for the FES simple-computer Quartus bring-up.
//
...
`endif
    ...
    // SMS 8255 Port A/B. Keyboard bits 0..9 keep the Coleco first-slice
    // matrix: P1 Up/Right/Down/Left/Fire1, P2 the same. Active-low.
...
`ifdef FES_SMS_REGISTERED_MEDIA
`undef FES_SMS_REGISTERED_MEDIA
`endif
