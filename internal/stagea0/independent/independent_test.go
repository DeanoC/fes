...
func reviewedLockFixture() stagea0.MainLock {
	return stagea0.MainLock{
		...
		Materials: []stagea0.Material{
			{ID: "oci", Role: "consumed-build-input", OCI: &stagea0.OCIMaterial{ManifestDigest: firstbuild.ExpectedContainerManifestDigest, ConfigDigest: firstbuild.ExpectedContainerConfigDigest, OS: firstbuild.ExpectedContainerOS, Architecture: firstbuild.ExpectedContainerArchitecture}},
