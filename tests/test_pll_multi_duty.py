...
class PllMultiDutyTests(unittest.TestCase):
    def test_closed_resources_and_sources(self):
        policy = policy_for("270_pll_multi_duty")
        ...
        rtl = (ROOT / "experiments/270_pll_multi_duty/rtl/top.v").read_text()
        policy.validate_source_text("experiments/270_pll_multi_duty/rtl/top.v", rtl)
        ...
        self.assertIn(".duty_cycle1(50)", rtl)
        self.assertIn(".duty_cycle2(25)", rtl)
        self.assertIn("16'hD71E", rtl)
