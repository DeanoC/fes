...
YOSYS_COMMIT = "ea0c44fc0dda595abee4cc27981ecf173628fc5c"
NEXTPNR_COMMIT = "06747fec1cb02405c3400ceac54d15c0845dcc0b"
YOSYS_DIGEST = "a" * 64
NEXTPNR_DIGEST = "b" * 64
SOURCE_HASHES = {
...
class OssSummaryTests(unittest.TestCase):
    ...
    def test_summary_contains_final_timing_resources_tools_and_stability(self) -> None:
        ...
        self.assertEqual(summary["authenticated_tools"]["yosys"]["commit"], "ea0c44fc0dda595abee4cc27981ecf173628fc5c")
