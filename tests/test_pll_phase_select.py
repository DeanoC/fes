...
class PllPhaseSelectTests(unittest.TestCase):
    def test_closed_resources_and_sources(self):
        policy = policy_for("290_pll_phase_select")
        ...
        rtl = (ROOT / "experiments/290_pll_phase_select/rtl/top.v").read_text()
        policy.validate_source_text("experiments/290_pll_phase_select/rtl/top.v", rtl)
        ...
        self.assertIn('.phase_shift3("0 ps")', rtl)
        self.assertIn("16'hD720", rtl)
