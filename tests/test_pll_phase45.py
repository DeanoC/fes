...
class PllPhase45Tests(unittest.TestCase):
    def test_closed_resources_and_sources(self):
        policy = policy_for("340_pll_phase45")
        ...
        rtl = (ROOT / "experiments/340_pll_phase45/rtl/top.v").read_text()
        policy.validate_source_text("experiments/340_pll_phase45/rtl/top.v", rtl)
        ...
        self.assertIn('.phase_shift2("15000 ps")', rtl)
        self.assertIn('.phase_shift3("17500 ps")', rtl)
        self.assertIn("16'hD725", rtl)
