...
module top #(
    ...
    (* ram_style = "m10k_tdp" *) reg [9:0] mem [0:1023];
    reg [9:0] q_a = 10'd0;
    reg [9:0] q_b = 10'd0;
    integer i;
    ...
    wire [9:0] data_a = seed_a ^ 10'h200;
    wire [9:0] data_b = seed_b ^ 10'h000;
    ...
    wire [9:0] selected_q = gp_out[26] ? q_b : q_a;
    wire [31:0] windowed = {22'd0, selected_q} >> {gp_out[27], 4'b0};
