...
int main(int argc, char **argv) {
    ...
    // Channel 2 is 100 MHz on hardware; this digital model is 50 MHz.
    const unsigned lo[3] = {2047U, 4095U, 4095U};
    const unsigned hi[3] = {2049U, 4097U, 4097U};
    ...
    std::cout << "PASS: multi-duty meters; reset zero, released 2048/4096 and 50 MHz digital 100 MHz stand-in\n";
}
