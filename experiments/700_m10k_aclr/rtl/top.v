// Independent-clock 512x20 M10K. Locked Yosys has no ACLR ports, so GPO[5]
// is the fabric clear net that nextpnr maps onto ACLR1 of the output register.
module top #(
    parameter [15:0] SIGNATURE = 16'hD426
) (
    ...
    // gp_out[5] is the fabric ACLR1 net; it is forced out of the table address.
    (* keep *) wire aclr = gp_out[5];
    reg armed = 1'b0;
