...
int main(int argc, char **argv) {
    ...
    for (unsigned channel = 0; channel < 2; ++channel) {
        select(channel);
        unsigned lo = channel ? 3276U : 2047U;
        unsigned hi = channel ? 3277U : 2049U;
    ...
    std::cout << "PASS: dual 25/40 MHz meters; reset zero, released 2048/3277 +/- 1\n";
}
