...
func (a *App) attractBlockedLocked() bool {
	...
	return a.attractDisabled || a.stopPhase == "stopping" || a.searchOpen || a.viewPickerOpen || a.settingsOpen || a.nameEntryOpenLocked() || a.collectionManageOpen || a.collectionConfirmOpen
}
