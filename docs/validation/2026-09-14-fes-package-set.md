...
~~~text
fes.pong router=HIP cache_root=.../out/cache/misteross-toolchains miss_builds=1 hit_builds=0 selection=fes-pong.package-selection.toml
fes.zx81 router=HIP cache_root=.../out/cache/misteross-toolchains miss_builds=1 hit_builds=0 selection=fes-zx81.package-selection.toml
fes.coleco router=HIP cache_root=.../out/cache/misteross-toolchains miss_builds=1 hit_builds=0 selection=fes-coleco.package-selection.toml
~~~
