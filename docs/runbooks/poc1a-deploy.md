...
4. Complete the normal MiSTer controller-mapping workflow. Launch each selected game once from the stock menu and confirm video, audio, a playable screen, and controller input.
