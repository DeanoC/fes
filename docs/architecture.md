...
profile (`M=52 N=5 C6=10`). Place-and-route uses `router1` and
`--tmg-ripup`. The recipe requires two `altera_pll` cells (52 MHz system
and 74.25 MHz pixel). Also required: the HPS GP
