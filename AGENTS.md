...
directory, and `make verify-media` only verifies that published file. Neither
command writes a block device. Read [the bootable-media guide](docs/bootable-media.md)
